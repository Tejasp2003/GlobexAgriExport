...
export default function TurmericExport() {
  ...
  const shareDescription = "Discover the vibrant color and exceptional quality of Indian turmeric from GlobexAgriExport. Request a quote today!";
  return (
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Offering premium Indian turmeric, known for its vibrant color and exceptional quality, to discerning customers worldwide.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-orange-700">Indian Turmeric Excellence</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-600 mb-4">
                India, the world's largest turmeric producer, yields 240,000 to 260,000 Metric Tons annually. Our turmeric, often called "Indian Saffron," is prized for its:
              </p>
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                ...
                <li>Wide-ranging applications in culinary, medicinal, and cosmetic industries</li>
              </ul>
            </CardContent>
          </Card>
        </div>
          ...
          {[
            {
              ...
              origin: "Kerala",
              description: "Known for high curcumin content and deep yellow to orange-yellow hue."
             
            },
            {
              name: "Rajapuri Turmeric",
              origin: "Maharashtra",
              description: "Distinctive variety with unique characteristics from Maharashtra.",
          
            },
            {
              name: "Salem Gattha Turmeric",
              origin: "Tamil Nadu",
              description: "Recognized for its distinct quality from Tamil Nadu's unique climate.",
              
            },
            {
              name: "Nizamabad Turmeric",
              origin: "Andhra Pradesh",
              description: "Cultivated in Andhra Pradesh, adding to India's rich turmeric tapestry.",
            ...
            <Card key={index}>
              ...
              <CardContent className="p-4">
                <h3 className="text-lg font-semibold text-orange-700 mb-2">{variety.name}</h3>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-3xl font-bold text-orange-700 flex items-center">
              <CheckCircle className="mr-2 h-8 w-8" /> Why Choose GlobexAgriExport for Indian Turmeric?
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-orange-50 p-4 rounded-lg">
                ...
                <p className="text-gray-600">Sourced from the finest turmeric-growing regions in India, ensuring superior color and curcumin content.</p>
              </div>
              <div className="bg-orange-50 p-4 rounded-lg">
                <h3 className="text-xl font-semibold text-orange-600 mb-2">🌿 Variety Selection</h3>
                <p className="text-gray-600">Offering a range of turmeric varieties to suit diverse customer needs and applications.</p>
              </div>
              <div className="bg-orange-50 p-4 rounded-lg">
                <h3 className="text-xl font-semibold text-orange-600 mb-2">🔬 Quality Assurance</h3>
                <p className="text-gray-600">Rigorous testing and quality control measures to meet international standards.</p>
              </div>
              <div className="bg-orange-50 p-4 rounded-lg">
              ...
              <div className="bg-orange-50 p-4 rounded-lg">
                ...
                <p className="text-gray-600">Extensive network allows us to export our premium turmeric to markets worldwide.</p>
              </div>
              <div className="bg-orange-50 p-4 rounded-lg">
                <h3 className="text-xl font-semibold text-orange-600 mb-2">📊 Market Insights</h3>
                <p className="text-gray-600">Providing valuable information on turmeric market trends and forecasts to our clients.</p>
              </div>
              <div className="bg-orange-50 p-4 rounded-lg">
